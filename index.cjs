...
// Set your deployed factory contract address in .env as FACTORY_CONTRACT_ADDRESS
const factoryAddress = process.env.FACTORY_CONTRACT_ADDRESS || "REPLACE_WITH_DEPLOYED_FACTORY_ADDRESS";
