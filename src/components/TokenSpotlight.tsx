...
import { X, ExternalLink, Copy, Star, Sparkles, TrendingUp, Users, DollarSign } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-8 max-w-2xl w-full mx-4 border border-slate-700/50 shadow-2xl">
        ...
        <div className="text-center mt-6 p-4 bg-gradient-to-r from-green-500/10 to-emerald-600/10 rounded-xl border border-green-500/20">
          <p className="text-green-400 font-medium">🎉 Congratulations! Your token is now part of the Sei ecosystem!</p>
          <p className="text-slate-400 text-sm mt-1">Share it with your community and start building!</p>
        </div>
      </div>
    </div>
  );
