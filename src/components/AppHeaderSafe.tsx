      ...
      <div className="app-container">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link 
              to="/app/trading" 
              className={`app-nav-link ${isActive('/app/trading') ? 'active' : ''}`}
            >
              🚀 Trading
            </Link>
            <Link 
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t app-border">
            <nav className="py-4 space-y-2">
              ...
              <Link to="/app/trading" className={`block px-4 py-2 rounded-lg transition-colors ${isActive('/app/trading') ? 'app-bg-secondary app-text-primary' : 'app-text-secondary hover:app-bg-secondary'}`} onClick={() => setIsMobileMenuOpen(false)}>🚀 Trading</Link>
