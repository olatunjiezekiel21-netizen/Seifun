...
export const getSeiDApps = async (): Promise<SeiDApp[]> => {
  ...
  return [
    ...
    },
    {
      ...
      image: 'https://pbs.twimg.com/profile_images/1508154678020489217/0cPvCrPa_400x400.jpg',
      category: 'DeFi',
      tvl: '$30M+',
      users: '15K+',
    ...
    },
    {
      ...
      image: 'https://pbs.twimg.com/profile_images/1676985308439969792/lNVF8eG1_400x400.jpg',
      category: 'DeFi',
      tvl: '$15M+',
      users: '8K+',
    ...
    },
    {
      ...
      image: 'https://pbs.twimg.com/profile_images/1714671879905140736/6cXmBJCb_400x400.jpg',
      category: 'DeFi',
      tvl: '$8M+',
      users: '5K+',
    ...
    },
    {
      ...
      image: 'https://pbs.twimg.com/profile_images/1704495251055886336/pBJEoY7F_400x400.jpg',
      category: 'Staking',
      tvl: '$12M+',
      users: '3K+',
