...
const Seilor = () => {
  ...
  const [chatMessages, setChatMessages] = useState<Array<{
  ...
  }>>([
    {
      id: 1,
      type: 'assistant',
      message: `🚀 **Welcome to Seilor 0 - Your Advanced AI Agent!**\n\nI'm powered by **CambrianAgents Sei Kit** + our revolutionary **Action Brain** and **Chat Brain** systems, giving me comprehensive DeFi capabilities and natural conversation intelligence.\n\n**🔥 What I can do:**\n• **Token Operations** - Scan, create, burn, and manage tokens\n• **Symphony DEX Trading** - "Swap 10 SEI for USDC" \n• **Silo Staking** - "Stake 50 SEI for yield"\n• **Takara Lending** - "Lend 100 USDC" or "Borrow 50 USDC"\n• **Citrex Trading** - "Open long position on SEI/USDC"\n• **Portfolio Intelligence** - Real-time balances and positions\n• **Natural Conversation** - Just talk to me like a friend!\n\n**💡 Try these advanced commands:**\n• **Token Analysis**: Paste any contract address (0x1234...)\n• **DeFi Operations**: "Swap 5 SEI for USDC via Symphony"\n• **Yield Farming**: "Stake 25 SEI on Silo for yield"\n• **Lending**: "Lend 200 USDC on Takara protocol"\n• **Trading**: "Open long position on SEI/USDC with 2x leverage"\n• **Portfolio**: "Show my wallet info" or "What are my positions?"\n\n**🎯 Powered by CambrianAgents - I'm your comprehensive DeFi agent with REAL protocol access!** ⚡`,
      timestamp: new Date()
    }
  ]);
